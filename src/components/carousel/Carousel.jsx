...
import indiaVsEngland from "../../assets/ind.jpg";
  ...
  const posters = [
    {
      ...
      trailerUrl:
        "https://www.youtube.com/watch?v=Lx53e78EzeE&list=PLLtUhzivrSZQoi2mY_RKcLmSmdgUcOySf&index=3",
    },
    {
      title: "F1: Drive to Survive",
      img: f1poster,
      desc: "Behind the scenes of Formula One racing with teams, rivalries, and adrenaline.",
      trailerUrl: "https://www.youtube.com/watch?v=69ffwl-8pCU&t=18s",
    },
    {
              ...
              <div className={`${styles.card} ${position}`} key={index}>
                ...
                <div className={styles.overlay}>
                  ...
                  <button
                    ...
                    onClick={() => {
                      setActiveTrailerUrl(poster.trailerUrl);
                      setShowTrailer(true);
                    }}
                  >
                    Watch Now
